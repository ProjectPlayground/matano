...
public class DBEvenement extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "evenements";
    ...
    public DBEvenement(Context context) {
     ...
     * @return
     */
    public List<Evenement> getDatas() {
    ...
    /**
     * Liste de tous les evenements cursor
     *
     * @return
     */
     ...
     * @return
     */
    public List<Evenement> getDatasByCategorie(String categorie) {
        SQLiteDatabase db = this.getReadableDatabase();

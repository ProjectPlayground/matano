...
public class DBCommentaire extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "Matano.db";
    private static final Integer DATBASE_VERSION = 1;
    private static final String TABLE_NAME = "commentaires";
    ...
    private static final String COLUMN_COMMENTAIRE = "commentaire";

    private static final String TABLE_DROP = "DROP TABLE IF EXISTS " + TABLE_NAME + ";";
    private static final String TABLE_CREATE = "CREATE TABLE " + TABLE_NAME + " (" + COLUMN_ID + " INTEGER PRIMARY KEY , " + COLUMN_NOM + " TEXT, " + COLUMN_PRENOM + " TEXT, " + COLUMN_TELEPHONE + " TEXT, " + COLUMN_JOUR + " TEXT, " + COLUMN_IMAGE + " TEXT, " + COLUMN_COMMENTAIRE + " TEXT );";


    private List<Commentaire> commentaires = new ArrayList<>();

    public DBCommentaire(Context context) {
    ...
    public void createData(Integer id, String nom, String prenom, String telephone, String jour, String image, String commentaire) {
    ...
    public List<Commentaire> getDatas() {
        ...
        for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
            commentaires.add(new Commentaire(
                    ...
                    cursor.getString(cursor.getColumnIndex(COLUMN_COMMENTAIRE))
            ));
        }
        cursor.close();

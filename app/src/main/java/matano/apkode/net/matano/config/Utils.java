...
public class Utils {
    ...
    public static final String FIREBASE_CHILD_USERS = "user";
    public static final String FIREBASE_CHILD_TICKETS = "ticket";
    ...
    public static final String FIREBASE_CHILD_USER_EVENTS = "events";
    public static final String FIREBASE_CHILD_USER_FOLLOWERS = "followers";
    public static final String FIREBASE_CHILD_USER_FOLLOWINGS = "followings";
    public static final String FIREBASE_CHILD_USER_PHOTOS = "photos";
